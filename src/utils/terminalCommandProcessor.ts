...
const commandList = [
  ...
  { commands: ['whoami'], description: 'Display a short bio' },
  { commands: ['skills'], description: 'Display skill set' },
  { commands: ['socials'], description: 'Display social links' },
]
...
export const processCommand = (terminalString: string, terminal: Terminal): void => {
  ...
  break
    ...
    case 'ipconfig':
      ...
      break
    case 'whoami':
      terminal.write('Shaka Nathan K\r\n')
      terminal.write('Developer & AI Engineer\r\n')
      terminal.write('Based in Kampala, Uganda\r\n')
      break
    case 'skills':
      terminal.write('Skills:\r\n')
      terminal.write('  - Frontend: React, TypeScript\r\n')
      terminal.write('  - AI Engineering: LLMs, agents\r\n')
      terminal.write('  - Python & data\r\n')
      break
    case 'socials':
      terminal.write('GitHub: https://github.com/TheyloveShaka\r\n')
      terminal.write('Email:  shakanathan.z@gmail.com\r\n')
      break
  default:
